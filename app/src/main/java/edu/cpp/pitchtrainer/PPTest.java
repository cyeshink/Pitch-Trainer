...
public class PPTest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(count<30){
            ...
            buttonnext.setOnClickListener(new View.OnClickListener(){
                public void onClick(View v) {
                    mp.release();
                    Intent myIntent = new Intent(PPTest.this, PPTest.class);
            ...
            setContentView(R.layout.pt_finish);
            finished = true;
            TextView cor = (TextView) findViewById(R.id.tvcorrect);
            TextView acc = (TextView) findViewById(R.id.tvacc);
            cor.setText(Integer.toString(correct));
            double accu = correct * 100.0 / 30.0;
            acc.setText(String.format("%.0f%%",accu));

            Button buttonmm = (Button) findViewById(R.id.buttonmm);
            buttonmm.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    finish();
                    Intent myIntent = new Intent(PPTest.this, MainActivity.class);
                    startActivity(myIntent);
                    finish();
